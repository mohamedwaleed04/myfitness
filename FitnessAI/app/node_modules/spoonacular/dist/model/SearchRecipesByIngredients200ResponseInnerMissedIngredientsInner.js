...
var SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('extendedName')) {
          obj['extendedName'] = _ApiClient["default"].convertToType(data['extendedName'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner.RequiredProperties),
        _step;
      try {
