 ...
 * @module model/AddMealPlanTemplate200ResponseItemsInner
 * @version 2.0.2
 */
var AddMealPlanTemplate200ResponseItemsInner = /*#__PURE__*/function () {
   ...
   * @alias module:model/AddMealPlanTemplate200ResponseItemsInner
   * @param day {Number} 
   * @param slot {Number} 
   ...
   */
  return _createClass(AddMealPlanTemplate200ResponseItemsInner, null, [{
    key: "initialize",
     ...
     * @param {module:model/AddMealPlanTemplate200ResponseItemsInner} obj Optional instance to populate.
     * @return {module:model/AddMealPlanTemplate200ResponseItemsInner} The populated <code>AddMealPlanTemplate200ResponseItemsInner</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>AddMealPlanTemplate200ResponseItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddMealPlanTemplate200ResponseItemsInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddMealPlanTemplate200ResponseItemsInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['value']) {
        // data not null
        _AddMealPlanTemplate200ResponseItemsInnerValue["default"].validateJSON(data['value']);
      }
      return true;
    }
  }]);
}();
AddMealPlanTemplate200ResponseItemsInner.RequiredProperties = ["day", "slot", "position", "type"];
...
/**
 * @member {module:model/AddMealPlanTemplate200ResponseItemsInnerValue} value
 */
