...
var GenerateMealPlan200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GenerateMealPlan200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GenerateMealPlan200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['meals']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['meals']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetSimilarRecipes200ResponseInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['nutrients']) {
        // data not null
        _GenerateMealPlan200ResponseNutrients["default"].validateJSON(data['nutrients']);
      }
      return true;
    }
  }]);
