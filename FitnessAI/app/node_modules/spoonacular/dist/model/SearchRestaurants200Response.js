...
var SearchRestaurants200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchRestaurants200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['restaurants']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['restaurants']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _SearchRestaurants200ResponseRestaurantsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
