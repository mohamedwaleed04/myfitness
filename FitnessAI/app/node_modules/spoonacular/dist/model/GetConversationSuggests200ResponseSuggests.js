...
var GetConversationSuggests200ResponseSuggests = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetConversationSuggests200ResponseSuggests, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetConversationSuggests200ResponseSuggests.RequiredProperties),
        _step;
      try {
      ...
      if (data['_']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['_']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetConversationSuggests200ResponseSuggestsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
