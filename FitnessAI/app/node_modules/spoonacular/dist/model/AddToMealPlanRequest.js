...
var _AddToMealPlanRequestValue = _interopRequireDefault(require("./AddToMealPlanRequestValue"));
...
var AddToMealPlanRequest = /*#__PURE__*/function () {
   ...
   */
  function AddToMealPlanRequest(date, slot, position, type, value) {
   ...
   */
  return _createClass(AddToMealPlanRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('value')) {
          obj['value'] = _AddToMealPlanRequestValue["default"].constructFromObject(data['value']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AddToMealPlanRequest.RequiredProperties),
        _step;
      try {
      ...
      if (data['value']) {
        // data not null
        _AddToMealPlanRequestValue["default"].validateJSON(data['value']);
      }
      return true;
    }
  }]);
