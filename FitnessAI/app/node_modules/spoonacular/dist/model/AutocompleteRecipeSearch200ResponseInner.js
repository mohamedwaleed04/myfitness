 ...
 * @module model/AutocompleteRecipeSearch200ResponseInner
 * @version 2.0.2
 */
var AutocompleteRecipeSearch200ResponseInner = /*#__PURE__*/function () {
   ...
   * @alias module:model/AutocompleteRecipeSearch200ResponseInner
   * @param id {Number} 
   * @param title {String} 
   ...
   */
  return _createClass(AutocompleteRecipeSearch200ResponseInner, null, [{
    key: "initialize",
     ...
     * @param {module:model/AutocompleteRecipeSearch200ResponseInner} obj Optional instance to populate.
     * @return {module:model/AutocompleteRecipeSearch200ResponseInner} The populated <code>AutocompleteRecipeSearch200ResponseInner</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>AutocompleteRecipeSearch200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutocompleteRecipeSearch200ResponseInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AutocompleteRecipeSearch200ResponseInner.RequiredProperties),
        _step;
      try {
...
AutocompleteRecipeSearch200ResponseInner.RequiredProperties = ["id", "title", "imageType"];
