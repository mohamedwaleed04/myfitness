...
var GetMealPlanTemplate200ResponseDaysInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetMealPlanTemplate200ResponseDaysInner, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetMealPlanTemplate200ResponseDaysInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['nutritionSummary']) {
        // data not null
        _GetMealPlanWeek200ResponseDaysInnerNutritionSummary["default"].validateJSON(data['nutritionSummary']);
      }
      // validate the optional field `nutritionSummaryBreakfast`
      if (data['nutritionSummaryBreakfast']) {
        // data not null
        _GetMealPlanWeek200ResponseDaysInnerNutritionSummary["default"].validateJSON(data['nutritionSummaryBreakfast']);
      }
      // validate the optional field `nutritionSummaryLunch`
      if (data['nutritionSummaryLunch']) {
        // data not null
        _GetMealPlanWeek200ResponseDaysInnerNutritionSummary["default"].validateJSON(data['nutritionSummaryLunch']);
      }
      // validate the optional field `nutritionSummaryDinner`
      if (data['nutritionSummaryDinner']) {
        // data not null
        _GetMealPlanWeek200ResponseDaysInnerNutritionSummary["default"].validateJSON(data['nutritionSummaryDinner']);
      }
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetMealPlanTemplate200ResponseDaysInnerItemsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
