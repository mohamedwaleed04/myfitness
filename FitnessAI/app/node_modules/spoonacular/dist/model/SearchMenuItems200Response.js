...
var SearchMenuItems200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchMenuItems200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('menuItems')) {
          obj['menuItems'] = _ApiClient["default"].convertToType(data['menuItems'], [_MenuItem["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchMenuItems200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['menuItems']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['menuItems']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _MenuItem["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
