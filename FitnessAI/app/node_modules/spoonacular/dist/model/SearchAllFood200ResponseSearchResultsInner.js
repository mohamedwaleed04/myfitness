...
var SearchAllFood200ResponseSearchResultsInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchAllFood200ResponseSearchResultsInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_SearchResult["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchAllFood200ResponseSearchResultsInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['results']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _SearchResult["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
