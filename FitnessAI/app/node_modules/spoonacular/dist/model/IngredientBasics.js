 ...
 * @version 2.0.2
 */
var IngredientBasics = /*#__PURE__*/function () {
  /**
   ...
   */
  function IngredientBasics(description, name, safetyLevel) {
    _classCallCheck(this, IngredientBasics);
   ...
   */
  return _createClass(IngredientBasics, null, [{
    key: "initialize",
    value: function initialize(obj, description, name, safetyLevel) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('safety_level')) {
          obj['safety_level'] = _ApiClient["default"].convertToType(data['safety_level'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(IngredientBasics.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = IngredientBasics;