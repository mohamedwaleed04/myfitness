...
var GetRecipeNutritionWidgetByID200ResponseBadInner = /*#__PURE__*/function () {
   ...
   */
  function GetRecipeNutritionWidgetByID200ResponseBadInner(title, amount, indented, percentOfDailyNeeds) {
    _classCallCheck(this, GetRecipeNutritionWidgetByID200ResponseBadInner);
    GetRecipeNutritionWidgetByID200ResponseBadInner.initialize(this, title, amount, indented, percentOfDailyNeeds);
  }
   ...
   */
  return _createClass(GetRecipeNutritionWidgetByID200ResponseBadInner, null, [{
    key: "initialize",
    value: function initialize(obj, title, amount, indented, percentOfDailyNeeds) {
      obj['title'] = title;
      obj['amount'] = amount;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetRecipeNutritionWidgetByID200ResponseBadInner.RequiredProperties),
        _step;
      try {
...
GetRecipeNutritionWidgetByID200ResponseBadInner.RequiredProperties = ["title", "amount", "indented", "percentOfDailyNeeds"];

/**
 * @member {String} title
 */
GetRecipeNutritionWidgetByID200ResponseBadInner.prototype['title'] = undefined;
