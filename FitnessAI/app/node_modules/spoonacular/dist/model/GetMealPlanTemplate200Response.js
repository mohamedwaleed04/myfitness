...
var GetMealPlanTemplate200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetMealPlanTemplate200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetMealPlanTemplate200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['days']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['days']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetMealPlanTemplate200ResponseDaysInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
GetMealPlanTemplate200Response.RequiredProperties = ["id", "name", "days"];
