...
var GetShoppingList200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetShoppingList200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetShoppingList200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['aisles']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['aisles']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetShoppingList200ResponseAislesInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
GetShoppingList200Response.RequiredProperties = ["aisles", "cost", "startDate", "endDate"];
