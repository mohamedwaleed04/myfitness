...
var _RecipeInformationExtendedIngredientsInnerMeasuresMetric = _interopRequireDefault(require("./RecipeInformationExtendedIngredientsInnerMeasuresMetric"));
 ...
 * @version 2.0.2
 */
var RecipeInformationExtendedIngredientsInnerMeasures = /*#__PURE__*/function () {
  /**
   ...
   */
  function RecipeInformationExtendedIngredientsInnerMeasures(metric, us) {
    _classCallCheck(this, RecipeInformationExtendedIngredientsInnerMeasures);
   ...
   */
  return _createClass(RecipeInformationExtendedIngredientsInnerMeasures, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('metric')) {
          obj['metric'] = _RecipeInformationExtendedIngredientsInnerMeasuresMetric["default"].constructFromObject(data['metric']);
        }
        if (data.hasOwnProperty('us')) {
          obj['us'] = _RecipeInformationExtendedIngredientsInnerMeasuresMetric["default"].constructFromObject(data['us']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RecipeInformationExtendedIngredientsInnerMeasures.RequiredProperties),
        _step;
      try {
      ...
      if (data['metric']) {
        // data not null
        _RecipeInformationExtendedIngredientsInnerMeasuresMetric["default"].validateJSON(data['metric']);
      }
      // validate the optional field `us`
      if (data['us']) {
        // data not null
        _RecipeInformationExtendedIngredientsInnerMeasuresMetric["default"].validateJSON(data['us']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = RecipeInformationExtendedIngredientsInnerMeasures;