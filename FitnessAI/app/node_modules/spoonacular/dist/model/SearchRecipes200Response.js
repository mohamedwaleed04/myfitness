...
var SearchRecipes200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchRecipes200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchRecipes200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['results']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _SearchRecipes200ResponseResultsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
SearchRecipes200Response.RequiredProperties = ["offset", "number", "results", "totalResults"];
