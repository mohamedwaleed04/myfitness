...
var SearchAllFood200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchAllFood200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchAllFood200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['searchResults']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['searchResults']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _SearchAllFood200ResponseSearchResultsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
