 ...
 * @module model/GetRecipeNutritionWidgetByID200ResponseGoodInner
 * @version 2.0.2
 */
var GetRecipeNutritionWidgetByID200ResponseGoodInner = /*#__PURE__*/function () {
   ...
   * @alias module:model/GetRecipeNutritionWidgetByID200ResponseGoodInner
   * @param amount {String} 
   * @param indented {Boolean} 
   * @param percentOfDailyNeeds {Number} 
   * @param title {String} 
   */
  function GetRecipeNutritionWidgetByID200ResponseGoodInner(amount, indented, percentOfDailyNeeds, title) {
   ...
   */
  return _createClass(GetRecipeNutritionWidgetByID200ResponseGoodInner, null, [{
    key: "initialize",
    value: function initialize(obj, amount, indented, percentOfDailyNeeds, title) {
      obj['amount'] = amount;
     ...
     * @param {module:model/GetRecipeNutritionWidgetByID200ResponseGoodInner} obj Optional instance to populate.
     * @return {module:model/GetRecipeNutritionWidgetByID200ResponseGoodInner} The populated <code>GetRecipeNutritionWidgetByID200ResponseGoodInner</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>GetRecipeNutritionWidgetByID200ResponseGoodInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRecipeNutritionWidgetByID200ResponseGoodInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetRecipeNutritionWidgetByID200ResponseGoodInner.RequiredProperties),
        _step;
      try {
