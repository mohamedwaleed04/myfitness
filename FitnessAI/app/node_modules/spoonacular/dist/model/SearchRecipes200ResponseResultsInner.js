...
var SearchRecipes200ResponseResultsInner = /*#__PURE__*/function () {
   ...
   */
  function SearchRecipes200ResponseResultsInner(id, title, image, imageType) {
   ...
   */
  return _createClass(SearchRecipes200ResponseResultsInner, null, [{
    key: "initialize",
    value: function initialize(obj, id, title, image, imageType) {
      obj['id'] = id;
      obj['title'] = title;
      obj['image'] = image;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchRecipes200ResponseResultsInner.RequiredProperties),
        _step;
      try {
