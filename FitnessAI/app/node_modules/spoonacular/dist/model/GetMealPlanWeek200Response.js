...
var GetMealPlanWeek200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetMealPlanWeek200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetMealPlanWeek200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['days']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetMealPlanWeek200ResponseDaysInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
