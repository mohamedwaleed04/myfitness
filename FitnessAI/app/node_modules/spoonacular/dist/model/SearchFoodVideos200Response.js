...
var SearchFoodVideos200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchFoodVideos200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchFoodVideos200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['videos']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _SearchFoodVideos200ResponseVideosInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
SearchFoodVideos200Response.RequiredProperties = ["videos", "totalResults"];
