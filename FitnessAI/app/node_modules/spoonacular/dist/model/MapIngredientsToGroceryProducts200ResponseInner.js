...
var MapIngredientsToGroceryProducts200ResponseInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(MapIngredientsToGroceryProducts200ResponseInner, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(MapIngredientsToGroceryProducts200ResponseInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['products']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _MapIngredientsToGroceryProducts200ResponseInnerProductsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
