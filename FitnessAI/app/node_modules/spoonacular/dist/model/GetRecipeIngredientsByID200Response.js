 ...
 * @module model/GetRecipeIngredientsByID200Response
 * @version 2.0.2
 */
var GetRecipeIngredientsByID200Response = /*#__PURE__*/function () {
   ...
   * 
   * @alias module:model/GetRecipeIngredientsByID200Response
   * @param ingredients {Array.<module:model/GetRecipeIngredientsByID200ResponseIngredientsInner>} 
   */
   ...
   */
  return _createClass(GetRecipeIngredientsByID200Response, null, [{
    key: "initialize",
     ...
     * @param {module:model/GetRecipeIngredientsByID200Response} obj Optional instance to populate.
     * @return {module:model/GetRecipeIngredientsByID200Response} The populated <code>GetRecipeIngredientsByID200Response</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>GetRecipeIngredientsByID200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRecipeIngredientsByID200Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetRecipeIngredientsByID200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['ingredients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetRecipeIngredientsByID200ResponseIngredientsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
GetRecipeIngredientsByID200Response.RequiredProperties = ["ingredients"];

/**
 * @member {Array.<module:model/GetRecipeIngredientsByID200ResponseIngredientsInner>} ingredients
 */
