...
var GetWinePairing200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetWinePairing200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetWinePairing200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['productMatches']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['productMatches']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _GetWinePairing200ResponseProductMatchesInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
