...
var GetConversationSuggests200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetConversationSuggests200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('words')) {
          obj['words'] = _ApiClient["default"].convertToType(data['words'], ['String']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetConversationSuggests200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['suggests']) {
        // data not null
        _GetConversationSuggests200ResponseSuggests["default"].validateJSON(data['suggests']);
      }
