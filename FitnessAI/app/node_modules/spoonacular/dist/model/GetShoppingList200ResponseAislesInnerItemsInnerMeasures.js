...
var _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal = _interopRequireDefault(require("./GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal"));
...
var GetShoppingList200ResponseAislesInnerItemsInnerMeasures = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetShoppingList200ResponseAislesInnerItemsInnerMeasures, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('original')) {
          obj['original'] = _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].constructFromObject(data['original']);
        }
        if (data.hasOwnProperty('metric')) {
          obj['metric'] = _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].constructFromObject(data['metric']);
        }
        if (data.hasOwnProperty('us')) {
          obj['us'] = _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].constructFromObject(data['us']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetShoppingList200ResponseAislesInnerItemsInnerMeasures.RequiredProperties),
        _step;
      try {
      ...
      if (data['original']) {
        // data not null
        _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].validateJSON(data['original']);
      }
      // validate the optional field `metric`
      if (data['metric']) {
        // data not null
        _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].validateJSON(data['metric']);
      }
      // validate the optional field `us`
      if (data['us']) {
        // data not null
        _GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal["default"].validateJSON(data['us']);
      }
      return true;
    }
  }]);
