...
var AddMealPlanTemplate200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(AddMealPlanTemplate200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AddMealPlanTemplate200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _AddMealPlanTemplate200ResponseItemsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
AddMealPlanTemplate200Response.RequiredProperties = ["name", "items", "publishAsPublic"];
