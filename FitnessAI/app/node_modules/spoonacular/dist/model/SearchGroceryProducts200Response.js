...
var SearchGroceryProducts200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(SearchGroceryProducts200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SearchGroceryProducts200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['products']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _AutocompleteRecipeSearch200ResponseInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
