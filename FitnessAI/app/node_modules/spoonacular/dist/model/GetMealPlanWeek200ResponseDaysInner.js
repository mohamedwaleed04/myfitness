...
var GetMealPlanWeek200ResponseDaysInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetMealPlanWeek200ResponseDaysInner, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetMealPlanWeek200ResponseDaysInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetMealPlanWeek200ResponseDaysInnerItemsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
