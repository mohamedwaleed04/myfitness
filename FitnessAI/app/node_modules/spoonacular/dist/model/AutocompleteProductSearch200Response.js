...
var AutocompleteProductSearch200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(AutocompleteProductSearch200Response, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AutocompleteProductSearch200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['results']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _AutocompleteProductSearch200ResponseResultsInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
