 ...
 * @module model/GenerateMealPlan200ResponseNutrients
 * @version 2.0.2
 */
var GenerateMealPlan200ResponseNutrients = /*#__PURE__*/function () {
   ...
   * @alias module:model/GenerateMealPlan200ResponseNutrients
   ...
   */
  return _createClass(GenerateMealPlan200ResponseNutrients, null, [{
    key: "initialize",
     ...
     * @param {module:model/GenerateMealPlan200ResponseNutrients} obj Optional instance to populate.
     * @return {module:model/GenerateMealPlan200ResponseNutrients} The populated <code>GenerateMealPlan200ResponseNutrients</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateMealPlan200ResponseNutrients</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateMealPlan200ResponseNutrients</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GenerateMealPlan200ResponseNutrients.RequiredProperties),
        _step;
      try {
...
GenerateMealPlan200ResponseNutrients.RequiredProperties = ["calories", "carbohydrates", "fat", "protein"];
