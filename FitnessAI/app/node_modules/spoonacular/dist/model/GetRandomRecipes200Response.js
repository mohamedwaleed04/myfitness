...
var _RecipeInformation = _interopRequireDefault(require("./RecipeInformation"));
 ...
 * @module model/GetRandomRecipes200Response
 * @version 2.0.2
 */
var GetRandomRecipes200Response = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetRandomRecipes200Response, null, [{
    key: "initialize",
     ...
     * @param {module:model/GetRandomRecipes200Response} obj Optional instance to populate.
     * @return {module:model/GetRandomRecipes200Response} The populated <code>GetRandomRecipes200Response</code> instance.
     */
  }, {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recipes')) {
          obj['recipes'] = _ApiClient["default"].convertToType(data['recipes'], [_RecipeInformation["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetRandomRecipes200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRandomRecipes200Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetRandomRecipes200Response.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipes']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['recipes']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _RecipeInformation["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
