...
var GetSimilarRecipes200ResponseInner = /*#__PURE__*/function () {
   ...
   */
  return _createClass(GetSimilarRecipes200ResponseInner, null, [{
    key: "initialize",
     ...
     * @param {module:model/GetSimilarRecipes200ResponseInner} obj Optional instance to populate.
     * @return {module:model/GetSimilarRecipes200ResponseInner} The populated <code>GetSimilarRecipes200ResponseInner</code> instance.
     */
  }, {
    ...
    /**
     * Validates the JSON data with respect to <code>GetSimilarRecipes200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSimilarRecipes200ResponseInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetSimilarRecipes200ResponseInner.RequiredProperties),
        _step;
      try {
...
GetSimilarRecipes200ResponseInner.RequiredProperties = ["id", "title", "imageType", "readyInMinutes", "servings", "sourceUrl"];
