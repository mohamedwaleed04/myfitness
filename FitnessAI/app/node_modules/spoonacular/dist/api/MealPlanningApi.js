...
var _AddMealPlanTemplate200Response = _interopRequireDefault(require("../model/AddMealPlanTemplate200Response"));
var _AddToMealPlanRequest = _interopRequireDefault(require("../model/AddToMealPlanRequest"));
var _AddToShoppingListRequest = _interopRequireDefault(require("../model/AddToShoppingListRequest"));
var _ConnectUser200Response = _interopRequireDefault(require("../model/ConnectUser200Response"));
var _ConnectUserRequest = _interopRequireDefault(require("../model/ConnectUserRequest"));
var _GenerateMealPlan200Response = _interopRequireDefault(require("../model/GenerateMealPlan200Response"));
var _GetMealPlanTemplate200Response = _interopRequireDefault(require("../model/GetMealPlanTemplate200Response"));
var _GetMealPlanTemplates200Response = _interopRequireDefault(require("../model/GetMealPlanTemplates200Response"));
var _GetMealPlanWeek200Response = _interopRequireDefault(require("../model/GetMealPlanWeek200Response"));
var _GetShoppingList200Response = _interopRequireDefault(require("../model/GetShoppingList200Response"));
...
var MealPlanningApi = exports["default"] = /*#__PURE__*/function () {
  ...
  */
   ...
   */
  return _createClass(MealPlanningApi, [{
    key: "addMealPlanTemplate",
    value: function addMealPlanTemplate(username, hash, callback) {
      var postBody = null;
    ...
    value: function addToShoppingList(username, hash, addToShoppingListRequest, callback) {
      var postBody = addToShoppingListRequest;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
    ...
    value: function clearMealPlanDay(username, date, hash, callback) {
      var postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
    ...
    key: "connectUser",
    value: function connectUser(connectUserRequest, callback) {
      var postBody = connectUserRequest;
    ...
    value: function deleteFromMealPlan(username, id, hash, callback) {
      var postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
    ...
    value: function deleteFromShoppingList(username, id, hash, callback) {
      var postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
    ...
    value: function deleteMealPlanTemplate(username, id, hash, callback) {
      var postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
    ...
    value: function generateShoppingList(username, startDate, endDate, hash, callback) {
      var postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
      ...
      var accepts = ['application/json'];
      var returnType = _GetShoppingList200Response["default"];
      return this.apiClient.callApi('/mealplanner/{username}/shopping-list/{start_date}/{end_date}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    value: function getMealPlanWeek(username, startDate, hash, callback) {
      ...
      return this.apiClient.callApi('/mealplanner/{username}/week/{start_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
